...
def create_trainset():
    ...
    """
    trainset_tf = dict()
    trainset_tf[u'0'] = (0,1,1)
    trainset_tf[u'1'] = (1,1,1)
    trainset_tf[u'2'] = (2,1,1)
    trainset_tf[u'3'] = (3,1,1)

    trainset_class = dict()
    trainset_class[u'0'] = '0'
    trainset_class[u'1'] = '0'
    trainset_class[u'2'] = '1'
    trainset_class[u'3'] = '1'
